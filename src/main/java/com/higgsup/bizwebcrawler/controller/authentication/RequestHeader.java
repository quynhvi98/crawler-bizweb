...
public class RequestHeader {
    ...
    public static final String RQ_ACCEPT = "accept";
    public static final String RQ_ACCEPT_VALUE = "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8";
    public static final String RQ_ACCEPT_LANGUAGE = "accept-language";
    public static final String RQ_ACCEPT_LANGUAGE_VALUE  = "en-US,en;q=0.8,vi;q=0.6,en-GB;q=0.4";
}
